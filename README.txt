...
How the site works:
        Playlist is right under the music player.
        Every time you click on a song under the player, it gets played.
        Every time the song changes, background color changes randomly.
        ...
        When a song ends ,next random song from playlist gets played automatically.

Future Plans:
        Add a feature for automatcally sorting the playlist.
        Add a feature for automatic sequential playing of songs from playlist.
